package Java_seminar.seminar_3.cw2;
...
public class Ex2 {
    /**
     * 2.Дан массив объектов: фамилия студента,
     * номер группы, размер стипендии, баллы по 3 предметам.
    ...
    public static List<Student> GetStudents()
    {
        ...
        students.add(new Student("name6", 3333, 1100, Arrays.asList(6,2,5)));
            return students;
        }
    }
